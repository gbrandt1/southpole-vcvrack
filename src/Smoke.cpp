...
struct SmokeWidget : ModuleWidget {
  ...
  SmokeWidget(Smoke *module) {
    ...
    {
      panel1 = new SVGPanel();
      panel1->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Smoke-parasite.svg")));
      panel1->box.size = box.size;
      addChild(panel1);
    }
    {
      panel2 = new SVGPanel();
      panel2->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Espectro-parasite.svg")));
      panel2->box.size = box.size;
      addChild(panel2);
    }
    {
      panel3 = new SVGPanel();
      panel3->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Ritardo-parasite.svg")));
      panel3->box.size = box.size;
      addChild(panel3);
    }
    {
      panel4 = new SVGPanel();
      panel4->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Camilla-parasite.svg")));
      panel4->box.size = box.size;
      addChild(panel4);
    }
    {
      panel5 = new SVGPanel();
      panel5->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Oliverb.svg")));
      panel5->box.size = box.size;
      addChild(panel5);
    }
    {
      panel6 = new SVGPanel();
      panel6->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Resonestor.svg")));
    ...
    {
      panel1 = new SVGPanel();
      panel1->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Smoke.svg")));
      panel1->box.size = box.size;
      addChild(panel1);
    }
    {
      panel2 = new SVGPanel();
      panel2->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Espectro.svg")));
      panel2->box.size = box.size;
      addChild(panel2);
    }
    {
      panel3 = new SVGPanel();
      panel3->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Ritardo.svg")));
      panel3->box.size = box.size;
      addChild(panel3);
    }
    {
      panel4 = new SVGPanel();
      panel4->setBackground(APP->window->loadSvg(assetPlugin(pluginInstance, "res/Camilla.svg")));
      panel4->box.size = box.size;
      addChild(panel4);
    }
  #endif
